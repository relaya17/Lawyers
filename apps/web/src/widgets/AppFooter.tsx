        ...
        <Grid container spacing={4} justifyContent="center" sx={{ textAlign: 'center' }}>
          ...
          <Grid item xs={12} md={4}>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1, alignItems: 'center' }}>
              ...
              <Link component={RouterLink} to="/simulator" color="inherit" variant="body2">
                {t('navigation.simulator', { defaultValue: 'סימולטור' })}
              </Link>
              <Link component={RouterLink} to="/risk-analysis" color="inherit" variant="body2">
