  ...
  return (
    <Box sx={{ 
      ...
      <Box sx={{ 
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 2, minWidth: 0, textAlign: 'center' }}>
          <Box sx={{
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'center',
          ...
          <Box sx={{ minWidth: 0, textAlign: 'center' }}>
            <Typography
              variant="h4"
              // Home page already has an H1; keep this as a section heading for accessibility.
              component="h2"
              gutterBottom
              sx={{
                fontWeight: 'bold',
      ...
      <Grid container spacing={3} sx={{ mb: 4 }}>
        <Grid item xs={12} sm={6} md={3}>
          <Card sx={{
            position: 'relative',
            backgroundImage: `linear-gradient(135deg, ${alpha(theme.palette.primary.main, theme.palette.mode === 'dark' ? 0.18 : 0.10)} 0%, ${alpha(theme.palette.primary.main, theme.palette.mode === 'dark' ? 0.30 : 0.18)} 100%)`,
            borderRadius: 3,
            borderInlineStart: `6px solid ${theme.palette.primary.main}`,
            boxShadow: `0 8px 25px ${alpha(theme.palette.primary.main, 0.18)}`,
            border: `1px solid ${alpha(theme.palette.primary.main, 0.18)}`,
            transition: 'all 0.3s ease-in-out',
            '&:hover': {
              transform: 'translateY(-4px)',
              boxShadow: `0 12px 35px ${alpha(theme.palette.primary.main, 0.28)}`,
            },
          }}>
            <CardContent sx={{ p: 3 }}>
        ...
        <Grid item xs={12} sm={6} md={3}>
          <Card sx={{
            position: 'relative',
            backgroundImage: `linear-gradient(135deg, ${alpha(theme.palette.warning.main, theme.palette.mode === 'dark' ? 0.18 : 0.10)} 0%, ${alpha(theme.palette.warning.main, theme.palette.mode === 'dark' ? 0.30 : 0.18)} 100%)`,
            borderRadius: 3,
            borderInlineStart: `6px solid ${theme.palette.warning.main}`,
            boxShadow: `0 8px 25px ${alpha(theme.palette.warning.main, 0.18)}`,
            border: `1px solid ${alpha(theme.palette.warning.main, 0.18)}`,
            transition: 'all 0.3s ease-in-out',
            '&:hover': {
              transform: 'translateY(-4px)',
              boxShadow: `0 12px 35px ${alpha(theme.palette.warning.main, 0.28)}`,
            },
          }}>
            <CardContent sx={{ p: 3 }}>
              <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 2 }}>
                <Box sx={{
                  ...
                  height: 50,
                  borderRadius: '50%',
                  backgroundColor: alpha(theme.palette.warning.main, theme.palette.mode === 'dark' ? 0.22 : 0.14),
                }}>
        ...
        <Grid item xs={12} sm={6} md={3}>
          <Card sx={{
            position: 'relative',
            backgroundImage: `linear-gradient(135deg, ${alpha(theme.palette.secondary.main, theme.palette.mode === 'dark' ? 0.18 : 0.10)} 0%, ${alpha(theme.palette.secondary.main, theme.palette.mode === 'dark' ? 0.30 : 0.18)} 100%)`,
            borderRadius: 3,
            borderInlineStart: `6px solid ${theme.palette.secondary.main}`,
            boxShadow: `0 8px 25px ${alpha(theme.palette.secondary.main, 0.18)}`,
            border: `1px solid ${alpha(theme.palette.secondary.main, 0.18)}`,
            transition: 'all 0.3s ease-in-out',
            '&:hover': {
              transform: 'translateY(-4px)',
              boxShadow: `0 12px 35px ${alpha(theme.palette.secondary.main, 0.28)}`,
            },
          }}>
            <CardContent sx={{ p: 3 }}>
              <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 2 }}>
                <Box sx={{
                  ...
                  height: 50,
                  borderRadius: '50%',
                  backgroundColor: alpha(theme.palette.secondary.main, theme.palette.mode === 'dark' ? 0.22 : 0.14),
                }}>
        ...
        <Grid item xs={12} sm={6} md={3}>
          <Card sx={{
            position: 'relative',
            backgroundImage: `linear-gradient(135deg, ${alpha(theme.palette.success.main, theme.palette.mode === 'dark' ? 0.18 : 0.10)} 0%, ${alpha(theme.palette.success.main, theme.palette.mode === 'dark' ? 0.30 : 0.18)} 100%)`,
            borderRadius: 3,
            borderInlineStart: `6px solid ${theme.palette.success.main}`,
            boxShadow: `0 8px 25px ${alpha(theme.palette.success.main, 0.18)}`,
            border: `1px solid ${alpha(theme.palette.success.main, 0.18)}`,
            transition: 'all 0.3s ease-in-out',
            '&:hover': {
              transform: 'translateY(-4px)',
              boxShadow: `0 12px 35px ${alpha(theme.palette.success.main, 0.28)}`,
            },
          }}>
            <CardContent sx={{ p: 3 }}>
              <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 2 }}>
        ...
        <Box sx={{ 
          ...
          <Tabs 
            ...
            sx={{
              ...
              '& .MuiTab-iconWrapper': {
                marginInlineEnd: { xs: 0.5, sm: 0.75 },
              },
              '& .MuiTabs-indicator': {
                height: 3,
