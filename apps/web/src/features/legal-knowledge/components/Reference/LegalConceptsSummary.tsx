...
interface LegalConcept {
  ...
  relatedTerms?: string[];
  legalSources?: string[];
  /** דגש פרקטי / קישור לסילבוס — מוצג מתחת להגדרה */
...
const legalConcepts: LegalConcept[] = [
  ...
  // ─── דיני ירושה ─────────────────────────────────────────────────────────
  {
    ...
    studyHighlight:
      'במבחנים: הבחנה בין ירושה על פי דין לצוואה, סדר העדיפויות (בן זוג/ילדים/הורים), ומה נכלל בעיזבון לעומת נכסים שלא עוברים בירושה (למשל ביטוח חיים לטובת מוטב).',
  },
  {
    id: 'will',
    term: 'צוואה',
    ...
    studyHighlight:
      'שימו לב לסוגי צוואות, כשירות המצווה, עדים, וביטול/חזרה מצוואה. צו קיום צוואה נדרש לרוב לפני רישום נכסים.',
  },
  {
    id: 'estate',
    term: 'עיזבון',
  ...
  },
  {
    ...
    studyHighlight:
      'צו ירושה — כשאין צוואה; צו קיום צוואה — לאחר בדיקת תוקף הצוואה. ללא צו — לרוב לא ניתן לרשום נכס או לגבות חובות מהעיזבון בצורה מסודרת.',
  },
  {
    id: 'disqualified-heir',
    term: 'פסול לרשת',
    definition: 'אדם שנפסל על פי חוק מלרשת את המוריש — למשל מי שגרם בכוונה למות המוריש או שפגע בחייו',
    category: 'דיני ירושה',
    importance: 'intermediate',
    examples: ['הרשעה בגרימת מוות בכוונה', 'התנכלות חמורה למוריש'],
    relatedTerms: ['ירושה על פי דין', 'צוואה', 'יורש'],
    legalSources: ['סעיף 6 לחוק הירושה'],
    studyHighlight:
      'נפוץ במבחנים: מתי נפסל היורש גם אם לא הורשע פלילית? קיימת פסיקה בנושא תנאי הפסילה והיקפה.',
  },
  {
    id: 'deathbed-gift',
    term: 'דין מהלך אכדמי (מתנה בערב מיתה)',
    definition: 'מתנה שניתנה בחיי המוריש כשהוא בסכנת מוות קרובה — ניתנת להשבה לעיזבון אם לא נתקיימו תנאים מסוימים בחוק',
    category: 'דיני ירושה',
    importance: 'advanced',
    examples: ['העברת חשבון בנק לילד ימים לפני הפטירה', 'מתנה לנכד בעת חולי סופני'],
    relatedTerms: ['עיזבון', 'מתנה', 'צוואה'],
    legalSources: ['חוק הירושה — הוראות בדבר מתנות בערב מיתה והשבה לעיזבון'],
    studyHighlight:
      'מבחן מרכזי: האם המתנה ניתנה «בערב מיתה» ומה תקופת הזכות להשיבה לעיזבון — חשוב ליישר קו עם הנוסח בחוק.',
  },
  {
    id: 'forced-heir-share',
    term: 'חלק היורשים השווים (זכות הקנין)',
    definition: 'במקרים מסוימים מעניק חוק הירושה הגנה ליורשים שווים (בעיקר ילדים) מפני נישול מוחלט בצוואה — ניתן לצמצם בחלק מהמקרים את חלק הצוואה הפוגע',
    category: 'דיני ירושה',
    importance: 'advanced',
    examples: ['צוואה המקצה הכל לזר', 'צוואה המנשלת ילד ללא עילה מוכרת'],
    relatedTerms: ['צוואה', 'יורשים על פי דין', 'עיזבון'],
    legalSources: ['סעיפים 5–6 לחוק הירושה; תיקונים ופסיקה'],
    studyHighlight:
      'נושא מתקדם: ההבדלים בין דורות של חוק הירושה והפסיקה — בשיעור ובמבחן יש להסתמך על הגרסה העדכנית שבסילבוס.',
  },
  {
    id: 'inheritance-debt',
    term: 'חובות המוריש והגבלת אחריות היורש',
    definition: 'היורשים אחראים לחובות המוריש רק עד גובה שווי הנכסים שקיבלו מהעיזבון — אין «אחריות אינסופית» על חובות אישיים של המנוח',
    category: 'דיני ירושה',
    importance: 'intermediate',
    examples: ['חובות בנק מול דירה בעיזבון', 'סירוב ירושה כדי לא לקבל חוב'],
    relatedTerms: ['עיזבון', 'כינוס נכסים', 'פשיטת רגל'],
    legalSources: ['חוק הירושה; חוק כינוס נכסים'],
    studyHighlight:
      'בפרקטיקה: סירוב ירושה בתוך המועד החוקי משחרר לעיתים מחובות — חשוב לבדוק מועדים ונוהל בפני רשם הירושה.',
  },
  {
    id: 'consumer',
    term: 'צרכן ועסקה צרכנית',
    definition: 'צרכן הוא אדם הנהנה ממוצר או שירות לצרכים אישיים–משפחתיים; עסקה צרכנית כפופה לחוק הגנת הצרכן ולתקנות הגנת הצרכן',
    category: 'דיני צרכנות',
    importance: 'basic',
    examples: ['רכישת מוצר מחנות', 'חוזה שירות לבית', 'רכישה אונליין'],
    relatedTerms: ['הטעיה', 'עושק', 'תקנון', 'ביטול עסקה'],
    legalSources: ['חוק הגנת הצרכן, התשמ"א–1981'],
    studyHighlight:
      'במבחנים: מתי צד הוא «צרכן», מתי חלה הגנת חוק הגנת הצרכן לעומת דיני חוזים כלליים, ומהן הזכויות לביטול או תיקון.',
  },
  {
    id: 'consumer-misleading',
    term: 'הטעיית צרכן',
    definition: 'מסירת מידע כוזב או השמטת מידע מהותי העלולים לגרום לצרכן לעשות עסקה שלא הייתה עושה אחרת',
    category: 'דיני צרכנות',
    importance: 'intermediate',
    examples: ['פרסום מחיר מטעה', 'הסתרת תשלומים נלווים', 'הבטחת יכולות שלא קיימות'],
    relatedTerms: ['עושק', 'תום לב', 'ביטול עסקה'],
    legalSources: ['סעיף 2 לחוק הגנת הצרכן'],
    studyHighlight:
      'מושג מקביל חלקית ל«טעות» בדיני חוזים — חשוב להבחין בין הטעיה לעושק ובין הסעדים.',
  },
];
...
const categories = [
  ...
  { id: 'דיני צרכנות', name: 'דיני צרכנות', icon: <DescriptionIcon /> },
];
...
export const LegalConceptsSummary: React.FC = () => {
  ...
  const categorySortOrder = categories.map((c) => c.id).filter((id) => id !== 'all');
  const sortedCategoryEntries = Object.entries(conceptsByCategory).sort(([a], [b]) => {
    const ia = categorySortOrder.indexOf(a);
    const ib = categorySortOrder.indexOf(b);
    ...
    <Container maxWidth="xl" sx={{ py: 4 }}>
      ...
      <Alert severity="info" sx={{ mb: 3 }} icon={false}>
        <Typography variant="subtitle2" gutterBottom>
          מציגים כעת {filteredConcepts.length} מושגים
          {selectedCategory !== 'all' || searchTerm
            ? ` (מתוך ${legalConcepts.length} במדריך)`
            : ''}
        </Typography>
        <Typography variant="body2" color="text.secondary">
          השתמשו בחיפוש ובשבבי הקטגוריה, ואז פתחו כל מושג — תמצאו הגדרה, דוגמאות, מושגים קשורים, מקורות חוקיים ודגש ללימוד.
          גללו מטה לרשימת המושגים המלאה לפי קטגוריות.
        </Typography>
      </Alert>

      {/* סטטיסטיקות — לפי הסינון הנוכחי */}
          ...
          <Card>
            <CardContent sx={{ textAlign: 'center' }}>
              <Typography variant="h4" color="success.main">
                {filteredConcepts.filter(c => c.importance === 'basic').length}
              </Typography>
              <Typography variant="body2" color="text.secondary">
                בסיסי בתצוגה
              </Typography>
          ...
          <Card>
            <CardContent sx={{ textAlign: 'center' }}>
              <Typography variant="h4" color="warning.main">
                {filteredConcepts.filter(c => c.importance === 'intermediate').length}
              </Typography>
              <Typography variant="body2" color="text.secondary">
                בינוני בתצוגה
              </Typography>
          ...
          <Card>
            <CardContent sx={{ textAlign: 'center' }}>
              <Typography variant="h4" color="error.main">
                {filteredConcepts.filter(c => c.importance === 'advanced').length}
              </Typography>
              <Typography variant="body2" color="text.secondary">
                מתקדם בתצוגה
              </Typography>
      ...
      {/* תוכן המושגים */}
      {sortedCategoryEntries.map(([category, concepts]) => (
              ...
              >
                ...
                <AccordionDetails>
                  <Box>
                    ...
                    {concept.studyHighlight && (
                      <Alert severity="success" sx={{ mb: 2, textAlign: 'start' }} icon={false}>
                        <Typography variant="subtitle2" gutterBottom>
                          דגש ללימוד
                        </Typography>
                        <Typography variant="body2">{concept.studyHighlight}</Typography>
                      </Alert>
                    )}
