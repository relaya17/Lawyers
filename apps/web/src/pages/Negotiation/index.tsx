  ...
  return (
    <Container maxWidth="lg">
      <Box sx={{ py: 4 }}>
        <PageHero
          title="חדר משא ומתן"
          subtitle="ניהול מו״מ חכם עם AI — הצעות, סבבי מו״מ, תיעוד מלא ומשוב אסטרטגי בזמן אמת. מבוסס על עקרונות המשא ומתן של ביה״ס למשפטים."
          chips={['AI אסטרטגי', 'תיעוד מלא', 'ניתוח הצעות']}
