...
export const RegulatoryCompliancePage: React.FC = () => {
  ...
  return (
    <Container maxWidth="xl" sx={{ py: 3 }}>
      <PageHero
        title="ציות רגולטורי"
        subtitle="ניטור אוטומטי של שינויים בחקיקה הישראלית — חוקי יסוד, תקנות, הנחיות רשויות ופסיקה מחייבת. התראות בזמן אמת ותאימות חוזים אוטומטית."
        chips={['חקיקה ישראלית 2026', 'התראות אוטומטיות', 'תאימות חוזים']}
