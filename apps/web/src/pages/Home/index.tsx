        ...
        <Container maxWidth="md" sx={{ position: 'relative', zIndex: 1, textAlign: 'center' }}>
          <MotionBox initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-80px' }} variants={stagger}>
            ...
            <MotionBox variants={fadeUp} custom={1} sx={{ display: 'flex', gap: 2, justifyContent: 'center', flexWrap: 'wrap' }}>
              ...
              <Button variant="text" size="large" onClick={() => navigate('/virtual-court-2')} aria-label="נסה את הסימולטור" sx={{ px: 4, py: 1.7, fontSize: '1.05rem', fontWeight: 700, borderRadius: 3, color: 'rgba(255,255,255,0.9)', '&:hover': { background: 'rgba(255,255,255,0.1)', color: '#fff' }, transition: 'all 0.25s ease' }}>
                נסה את הסימולטור
              </Button>
            </MotionBox>
