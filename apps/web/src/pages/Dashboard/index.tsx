...
export const DashboardPage: React.FC = () => {
  ...
  // התראות
  const notifications: Array<{ id: number; type: import('@mui/material').AlertColor; message: string; time: string }> = [
          ...
          <Grid item xs={12}>
            ...
            <Grid container spacing={2}>
              {[
                ...
                { icon: <School />, title: 'מקורות משפט', color: 'success', route: '/legal-knowledge' },
                { icon: <Handshake />, title: 'מו״מ (בית משפט)', color: 'info', route: '/virtual-court-2' },
