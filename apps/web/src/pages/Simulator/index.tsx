...
export const SimulatorPage: React.FC = () => {
  ...
  return (
    <Container maxWidth="lg">
      <Box sx={{ py: 3 }}>
        <PageHero
          title="סימולטור משפטי"
          subtitle="תרגלו הופעה בפני שופט וירטואלי, ניהול מו״מ, חקירת עדים וניתוח חוזים — מקרים המבוססים על פסיקת בית המשפט העליון ועם משוב AI מיידי."
          chips={['בית משפט וירטואלי', 'מקרים מבוססי פסיקה', 'משוב AI על טיעונים']}
