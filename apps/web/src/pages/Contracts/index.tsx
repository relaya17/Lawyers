  ...
  return (
    <Container maxWidth="lg">
      <Box sx={{ py: 4 }}>
        <PageHero
          title="ניהול חוזים"
          subtitle="ניהול מקצועי של כל החוזים שלך — יצירה, עריכה, מעקב סטטוס וניתוח סיכונים. ארכיב מסודר עם חיפוש מתקדם ותזכורות פקיעה."
          chips={['יצירה ועריכה', 'מעקב סטטוס', 'ניתוח סיכונים']}
        ...
        <Card variant="outlined" sx={{ mb: 3 }}>
          <CardContent sx={{ py: 2 }}>
            <Typography variant="subtitle2" color="text.secondary" gutterBottom>
              כלים מתקדמים (נגישים מניהול חוזים)
            </Typography>
            <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1} flexWrap="wrap" useFlexGap>
              ...
              >
                {t('navigation.riskAnalysis', { defaultValue: 'ניתוח סיכונים' })}
              </Button>
              <Button
                variant="outlined"
                size={isSmallMobile ? 'small' : 'medium'}
              ...
              >
                {t('navigation.regulatoryCompliance', { defaultValue: 'ציות רגולטורי' })}
              </Button>
              <Button
                variant="outlined"
                size={isSmallMobile ? 'small' : 'medium'}
              ...
              >
                {t('navigation.workflowAutomation', { defaultValue: 'אוטומציית תהליכים' })}
              </Button>
            </Stack>
          </CardContent>
        </Card>
