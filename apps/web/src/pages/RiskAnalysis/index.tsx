...
export const RiskAnalysisPage: React.FC = () => {
  ...
  return (
    <Container maxWidth="lg">
      <Box sx={{ py: 3 }}>
        <PageHero
          title="ניתוח סיכונים משפטי"
          subtitle="העלה חוזה לניתוח AI מעמיק — זיהוי סעיפים בעייתיים, השוואה לפסיקת בית המשפט העליון, התרעות על סיכונים ושיפורים מוצעים בזמן אמת."
          chips={['ניתוח חוזים AI', 'פסיקה עדכנית 2026', 'המלצות בזמן אמת']}
