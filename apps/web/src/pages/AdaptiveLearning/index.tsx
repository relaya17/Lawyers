  ...
  return (
    <Container maxWidth="lg" sx={{ mt: 2, mb: 4 }}>
      <PageHero
        ...
        subtitle="אלגוריתם AI בונה לך מסלול לימוד אישי לפי נקודות החוזק והחולשה שלך — חזרה מרווחת (Spaced Repetition), זיהוי פערים אוטומטי והמלצות בזמן אמת."
        chips={['מפת ידע אישית', 'חזרה מרווחת', 'זיהוי פערים אוטומטי']}
                ...
                <Card>
                  <CardContent>
                    ...
                    <Button 
                      variant="outlined" 
                      startIcon={<PlayArrowIcon />}
                      onClick={() => { /* TODO: open question modal */ }}
                    >
                      התחל שאלה
                    </Button>
                  </CardContent>
